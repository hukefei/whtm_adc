...
def default_rule(det_lst, img_path, img_name, json_config_file, code_file, draw_img=False):
    """
    ...
    # judge RES04
    df_res05 = det_df[(det_df['category'] == 'RES05') & (det_df['score'] >= 0.5)]
    if len(df_res05) >= 3:
        det_df.loc[det_df['category'] == 'RES05', 'category'] = 'RES04'
