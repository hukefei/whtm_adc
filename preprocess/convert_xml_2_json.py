...
if __name__ == '__main__':
    file_dir = r'F:\WHTM\MASK\data\train_val\val'
    img_dir = r'F:\WHTM\MASK\data\train_val\val'
    name_lst = []
    ...
    json_file = r'F:\WHTM\MASK\data\train_val\val.json'
    code_file = r'F:\WHTM\MASK\data\train_val\classes.txt'
